...
<div class="btn-toolbar" id="user-list-toobar">
    <#if permissionResolver.allow('perm_sysadm_user')>
        <div class="btn-group">
            <a class="btn" data-dialog data-dialog-aftersubmit="refreshDataTable('${tableId}')"
    ...
    var columns_${tableId} = [
        ...
        { mDataProp: "login_name", sTitle: "操作", sClass: "center",
            ...
            fnRender: function (o) {
                ...
                return '<a class="btn btn-mini" data-dialog href="' + href + '" data-dialog-aftersubmit="refreshDataTable(\'${tableId}\')"><i class="fa fa-cog"></i></a>';
            }
        }
    ];
</script>
