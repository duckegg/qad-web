...
<link type="text/css" rel="stylesheet" media="all"
      href="${base}/media/jquery/themes/smoothness/jquery-ui-1.10.2.custom.css"/>
<#-- bootstrap -->
...
<link type="text/css" rel="stylesheet" media="all"
      href="${base}/media/bs3-ext/css/jasny-bootstrap.css"/>
...
<script type="text/javascript"
        src="${base}/media/datatables/jquery.dataTables.grouping.js"></script>
<script type="text/javascript" src="${base}/media/datatables/ColReorderWithResize.js"></script>
<script type="text/javascript"
        src="${base}/media/datatables/jquery.dataTables.rowReordering.js"></script>
<#-- jqplot -->
<!--[if lt IE 9]>
...
<script type="text/javascript"
        src="${base}/media/jqplot/plugins/jqplot.dateAxisRenderer.js"></script>
<script type="text/javascript"
        src="${base}/media/jqplot/plugins/jqplot.barRenderer.min.js"></script>
<script type="text/javascript"
        src="${base}/media/jqplot/plugins/jqplot.pieRenderer.min.js"></script>
<script type="text/javascript"
        src="${base}/media/jqplot/plugins/jqplot.categoryAxisRenderer.min.js"></script>
<script type="text/javascript"
        src="${base}/media/jqplot/plugins/jqplot.pointLabels.min.js"></script>
<script type="text/javascript"
        src="${base}/media/jqplot/plugins/jqplot.canvasTextRenderer.min.js"></script>
<script type="text/javascript"
        src="${base}/media/jqplot/plugins/jqplot.canvasAxisTickRenderer.min.js"></script>
<script type="text/javascript"
        src="${base}/media/jqplot/plugins/jqplot.canvasAxisLabelRenderer.min.js"></script>
...
<script type="text/javascript"
        src="${base}/media/jqplot/jqplot.enhancedLegendRenderer.leo.js"></script>
...
<script type="text/javascript"
        src="${base}/media/datepicker/daterangepicker.jQuery.custom.js"></script>
<link rel='stylesheet' type='text/css' href='${base}/media/calendar/fullcalendar.css'/>
<link rel='stylesheet' type='text/css' href='${base}/media/calendar/fullcalendar.print.css'
      media="print"/>
