...
<#--
********************************************************************************
Build table with static data source
********************************************************************************
-->
<#macro staticTable tableId ajaxUrl="" ajaxForm="" serverSide=false
rowGroup="" rowReordering=false rowIdDataField="" rowReorderOptions=""
filter=true colVis=true columnFilter=false scrollable=true
autoWidth=false printable=false printPid="" height="auto" theme=""
toolbarElement=""
    ...
    <#--###### ColVis Extras ######-->
        ...
        "fnInitComplete": function () {
            ...
            <#if ajaxheader>
                ...
                if($tableWrapper){
                    var $tablehead =$("#"+"${tableId}_wrapper"+" .dataTables_scrollHeadInner table thead");
                }else{
                var $tablehead = $(".dataTables_scrollHeadInner table thead");
                }
