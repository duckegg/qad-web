...
<#-- bootstrap -->
<link rel='stylesheet' type='text/css' href='${base}/media/app/lib/bootstrap-light.css'/>
<link type="text/css" rel="stylesheet" media="all" href="${base}/media/bootstrap/ext/jasny-bootstrap.css"/>
...
<#--<link rel="stylesheet/less" type="text/css" href="${base}/media/app/less/kui-light.less" media="all">-->
<#--<script type="text/javascript" src="${base}/media/bootstrap/less-1.5.1.min.js"></script>-->
