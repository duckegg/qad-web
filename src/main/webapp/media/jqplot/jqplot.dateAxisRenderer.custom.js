...
(function($) {  
    ...
    $.jqplot.DateAxisRenderer.prototype.createTicks = function(plot) {
        ...
        // https://bitbucket.org/tomasc/jqplot/changeset/42d2445cdd45
        // Reference:
        // http://stackoverflow.com/questions/8588510/why-does-jqplots-dateaxisrenderer-crash-when-showing-a-single-data-point
        ...
        // if user specified min and max are null, we set those to make best ticks.
            ...
            if (titarget <= 19*day) {
                ...
                //LEOLIAO@2012/08/10: We donot need UTC offset
                //https://groups.google.com/group/jqplot-users/tree/browse_frm/month/2012-01/b052b53c5527bc39?rnum=51&_done=/group/jqplot-users/browse_frm/month/2012-01?&pli=1
                //https://bitbucket.org/cleonello/jqplot/issue/602/error-in-x-axis-when-zooming-a-hourly
//                min = new $.jsDate(min);
