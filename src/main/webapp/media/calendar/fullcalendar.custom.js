 ...
 * Implemented from www.it-design.es
 *
...
// TODO: use same function formatDate(date, [date2], format, [options])
    ...
    var dateFormatters = {
        ...
        e:function (d, o) {
            return o.dayNamesShortest[d.getDay()]
        }, //add by Kebin ----> 5
        dddd:function (d, o) {
    ...
    function BasicYearView(element, calendar, viewName) {
        ...
        function buildSkeleton(maxRowCnt, showNumbers) {
            ...
            for (var mi = 0; mi < 12; mi++) {
                ...
                //LEO@2012/12/03: move event out of code
//                s += "<td class='fc-year-monthly-td'><a class='yearLink' href='#' data-month='2012" + "-" + (mi + 1) + "' onClick='moveToMonth(\"" + ("2012" + "-" + (mi + 1)) + "\");return false'>";
                s += "<td class='fc-year-monthly-td'><a class='yearLink' href='#' data-month='2012" + "-" + (mi + 1) + "'>";
                ...
                for (i = 0; i < 6; i++) {
                    ...
                    for (j = 0; j < colCnt; j++) {
                        ...
                        s += "<td class='fc- " + contentClass + " fc-day" + dayStr + "'>" + // need fc- for setDayID
                            "<div>" + //<a href='#' onClick='moveToDay(\""+showNumbers+"\");return false'>
                            (showNumbers ?
                                "<div class='fc-day-number'/>" : //</a>
                                ''
                                ) +
                            "<div class='fc-day-content'>" +
                            //"<div style='position:relative;height:2px;width:25px;background-color:red;' id='yearSEv'>&nbsp;</div>" +
                            "</div>" +
                            "</div>" +
                            "</td>";
                        addDays(di, 1);
