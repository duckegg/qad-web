...
<@ui.page id="tab" title="Nav Demo">
<div class="alert alert-info">各种导航示例，包括Tab、Pill、List</div>
<h3>Pill Style - Horizontal</h3>
<div>
    <@ui.ajaxNav target="#tab-content1" class="nav-pills">
        <li><a href="#tab1" data-toggle="tab">Local 1</a></li>
        <li><a href="#tab2" data-toggle="tab">Local 2</a></li>
...
<div class="row">
    <div class="tabbable tabbable-custom">
        <@ui.ajaxNav class="nav-tabs" target="#tab-content4">
            ...
            <li><a href="#tab4-2" data-toggle="tab">Local 2</a></li>
            <li><a href="${base}/uidemo/ajax-result" data-toggle="tab">Ajax</a></li>
        </@ui.ajaxNav>
    </div>
...
<h3>Navbar Style</h3>
<div class="navbar">
        <@ui.ajaxNav target="#tab-content3">
            <li><a href="#tab3-1" data-toggle="tab">Local 1</a></li>
        ...
        <li><a href="#tab6-2" data-toggle="tab">自定义风格子菜单</a>
            <ul class="nav-custom-group">
                ...
                <li><a href="#">还有子菜单</a>
                    <ul>
                        <li><a href="${base}/uidemo/ajax-result" data-toggle="tab">Ajax</a></li>
                        <li><a href="${base}/uidemo/ajax-result" data-toggle="tab">Ajax Again</a>
                        </li>
                    </ul>
                </li>
            </ul>
