...
//    String href = "viewName=template_os_fc_by_gid&interfaceVersion=9.0.0&params=[GID=d60adc8aff0a9f25711a446af7ef845d]";
%>
...
<%--<ucmdb:ucmdb_applet--%>
        <%--serverConnectionString="http://localhost:8888"--%>
        <%--serverType="UCMDB"--%>
