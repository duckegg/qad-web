...
<div class="media toolbar-container">
    ...
    <div class="media-body">
        ...
        <#if type=="summary">
            <div class="toolbar-inline" style="display:none">
...
<div class="metadata clearfix">
    <ul class="list-unstyled list-inline pull-left unstyled inline">
        <li>
            <#if jpost.createdUser??><a data-kui-dialog href="${base}/user/view/${jpost.createdUser.id}">${jpost.createdUser.fullName!""}</a></#if>
        ${jpost.createdAt!""}
        </li>
        <#if type!="summary">
            <li>
    ...
    <ul class="list-unstyled list-inline tags pull-right unstyled inline">
        <li>
