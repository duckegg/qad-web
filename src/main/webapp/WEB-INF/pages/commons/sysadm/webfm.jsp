...
<%!
    static final Logger logger = LoggerFactory.getLogger("hpps.sysadm.Browser");
    //FEATURES
    ...
    private static final String RESTRICT_PATH = "/usr/opshere;E:\\";
...
<%
    ...
    final String browser_name = "/sysadm/webfm";
